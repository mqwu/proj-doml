setwd("/media/sf_DOML/data/case1/it17")
...
#### The data were partitioned into three parts: past generations, recent generations 
#### and current generation 
 
 recentgeneration<-2                #### it is a non-negative integer
   ...
   ###### Read recent and current data 
    ...
    if(generation>=miniter){
     ...
     for(k in (sum(DataFormat[1:2])+1):sum(DataFormat)){
         ...
         hidden_Act<-"Tanh"  #### either Rectifier or Tanh
